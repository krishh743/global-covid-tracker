...
import continentAction from '../Actions/continentActions'


const Continent = () => {
    const response = useSelector((state) => state.continentData.continentData)
    const dispatch = useDispatch()
    const [keyword, setKeyword] = useState('')

    useEffect(async () => {
        // console.log("usee")
        dispatch(continentAction())
            ...
            <div className="mid">
                ...
                <div style={{display: 'flex', flexDirection: 'row', width: '1000px', justifyContent: 'space-between', marginLeft: '35px'}}>
                    <Paper style={{padding: '47px', margin: '20px'}} >
                        ...
                        <h3 style={{textAlign: 'center'}} className="color-red">88,000</h3>
                    </Paper>
                    <Paper style={{padding: '47px', margin: '20px'}} >
                        <h3> Total Deaths </h3>
                        <h3 style={{textAlign: 'center'}} className="color-voilet">13,900</h3>
                    </Paper>
                    <Paper style={{padding: '47px', margin: '20px'}} >
                        <h3> Total recovered </h3>
                        <h3 style={{textAlign: 'center'}} className="color-green">45,676</h3>
                    </Paper>
                </div>
                <div style={{backgroundColor: 'dodgerblue', width: '1200px', marginLeft: '-95px', height: '450px', borderTopRightRadius: '20px', borderBottomRightRadius: '20px'}}>
                    <div>
                        <div style={{borderBottomRightRadius: '40px', borderTopRightRadius: '40px', backgroundColor: 'white', width: '750px', height: '450px'}}>
                            ...
                            <p className="all-info" style={{marginLeft: '830px', width: '300px'}}>
